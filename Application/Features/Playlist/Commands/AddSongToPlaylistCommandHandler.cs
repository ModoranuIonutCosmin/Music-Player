    ...
    PlaylistModel>
{
    ...
    public async Task<PlaylistModel> Handle(AddSongToPlaylistCommand request, CancellationToken cancellationToken)
    {
        ...
        await _playlistRepository.AddSongToPlaylistAsync(song, playlist);
